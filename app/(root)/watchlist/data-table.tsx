...
export function DataTable<TData, TValue>({
    ...
    return (
        <>
            <div className="max-h-[600px] rounded-lg border border-gray-600 bg-gray-800 overflow-y-auto">
                            ...
                            table.getRowModel().rows.map((row) => {
                                ...
                                return (
                                    <TableRow
                                        ...
                                        className="group border-b border-gray-600 hover:bg-gray-700/50  transition-colors data-[state=selected]:bg-gray-700"
                                    >
                                        <TableCell className="py-3 pl-4 border-r border-gray-600 transition-colors">
                                            <button
                                                onClick={(e) => {
                                                    e.preventDefault()
                                                    e.stopPropagation()
                                        ...
                                        {row.getVisibleCells().map((cell) => (
                                            <TableCell key={cell.id} className="text-gray-100 font-medium py-3 border-r border-gray-600 last:border-r-0 transition-colors">
